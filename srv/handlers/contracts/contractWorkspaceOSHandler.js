...
const { ContractWorkspace} = cds.entities('sap.ariba');
        ...
        for(const oData of aData) {
            ...
            try {
                ...
                try {
                    ...
                    await srv.run(DELETE(ContractWorkspace).where({
                        Realm : sRealm ,
                ...
                //New record, insert
                await srv.run( INSERT .into (ContractWorkspace) .entries (oDataCleansed) ); 
