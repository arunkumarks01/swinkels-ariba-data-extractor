...
const { RFXContentDocument} = cds.entities('sap.ariba');
        ...
        for(const oData of aData) {
            ...
            try {
                ...
                try {
                    ...
                    await srv.run(DELETE(RFXContentDocument).where({
                        Realm : sRealm ,
                ...
                //New record, insert
                await srv.run( INSERT .into (RFXContentDocument) .entries (oDataCleansed) ); 
