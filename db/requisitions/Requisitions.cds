...
entity Requisition: managed, types.customFields {
    key Realm                               : String(50);
    key UniqueName                          : String(50);
        ...
        ApprovalRecords                     : Composition of many Requisition_ApprovalRecords on ApprovalRecords.Requisition = $self;
        ApprovalRequests                    : Composition of many Requisition_ApprovalRequests on ApprovalRequests.Requisition = $self;
        LineItems                           : Composition of many Requisition_LineItem on LineItems.Requisition = $self;

}

entity Requisition_ApprovalRecords: cuid {
    key Requisition                         : Association to Requisition;
...
entity Requisition_ApprovalRequests: cuid {
    key Requisition                     : Association to Requisition;
...
entity Requisition_LineItem: cuid {
    ...
    SplitAccountings                    : Composition of many Requisition_LineItem_SplitAccountings on SplitAccountings.LineItem = $self;
}


entity Requisition_LineItem_SplitAccountings: cuid {
    key LineItem                    : Association to Requisition_LineItem;
        PONumber                    : String(50);
